...
class Annotator:
    ...
    def box_label(self, box, angle=0, label='', color=(128, 128, 128), txt_color=(255, 255, 255)):
        ...
        if self.pil or not is_ascii(label):
            rotatedBox = rotatedBox.flatten().tolist()
            rotatedBox.append(rotatedBox[0])
            rotatedBox.append(rotatedBox[1])
            self.draw.line(rotatedBox, fill=color)  # box
            if label:
        ...
        if len(targets) > 0:
            ...
            for j, box in enumerate(boxes.T.tolist()):
                ...
                if labels or conf[j] > 0.25:  # 0.25 conf thresh
                    ...
                    annotator.box_label(box, angle, label, color=color)
